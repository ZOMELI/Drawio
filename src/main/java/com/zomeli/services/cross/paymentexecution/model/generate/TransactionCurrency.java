...
@JsonTypeName("TransactionCurrency")
...
public class TransactionCurrency   {
  ...
  /**
   * Moneda en la que se realiza la operación
   **/
 ...
 @Pattern(regexp="^(PEN|USD)$")  public String getCode() {
  ...
  public boolean equals(Object o) {
    ...
    TransactionCurrency transactionCurrency = (TransactionCurrency) o;
    return Objects.equals(this.code, transactionCurrency.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionCurrency {\n");
