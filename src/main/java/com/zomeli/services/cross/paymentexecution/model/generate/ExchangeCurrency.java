...
public class ExchangeCurrency   {
  ...
  /**
   * Moneda destino de la C/V
   **/
  public ExchangeCurrency code(String code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExchangeCurrency exchangeCurrency = (ExchangeCurrency) o;
    return Objects.equals(this.code, exchangeCurrency.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangeCurrency {\n");
